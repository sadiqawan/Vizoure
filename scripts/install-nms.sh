...
UPDATE vizoure.hosts SET description = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(description,'Zabbix Agent (zabbix-agent2)','Vizoure Agent (vizoure-agent2)'),'Zabbix Agent 2','Vizoure Agent 2'),'zabbix-agent2','vizoure-agent2'),'Zabbix agent 2','Vizoure agent 2'),'Zabbix agent','Vizoure agent'),'Zabbix HTTP agent','Vizoure HTTP agent'),'Zabbix SNMP agent','Vizoure SNMP agent'),'Zabbix SNMP Agent','Vizoure SNMP Agent'),'Zabbix Java Gateway','Vizoure Java Gateway'),'Zabbix Java gateway','Vizoure Java gateway'),'Zabbix Helm Chart','Vizoure Helm Chart'),'Zabbix Helm chart','Vizoure Helm chart'),'Zabbix IAM policy','Vizoure IAM policy'),'Zabbix 7.4 ','Vizoure 7.4 '),'Zabbix 7.4.','Vizoure 7.4.'),'Zabbix 7.4,','Vizoure 7.4,'),'Zabbix 7.4+','Vizoure 7.4+'),'Zabbix Documentation','Vizoure Documentation'),'Zabbix Event Priority','Vizoure Event Priority'),'Zabbix Event Source','Vizoure Event Source'),'Zabbix Event Status','Vizoure Event Status'),'Zabbix GitHub Webhook','Vizoure GitHub Webhook'),'Zabbix/7.4','Vizoure/7.4'),'the local Zabbix server','the local Vizoure server'),'the local Zabbix proxy','the local Vizoure proxy'),'the remote Zabbix server','the remote Vizoure server'),'the remote Zabbix proxy','the remote Vizoure proxy'),'Zabbix bulk data collection','Vizoure bulk data collection'),'New Zabbix Agent','New Vizoure Agent') WHERE (description LIKE '%Zabbix%' OR description LIKE '%zabbix-agent2%') AND status=3;
