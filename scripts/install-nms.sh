...
cat > /tmp/vizoure_desc_fix.sql << 'SQLEOF'
-- Split into groups of 7 REPLACEs max to stay within MySQL limits
UPDATE vizoure.hosts SET description = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(description,'Zabbix Agent (zabbix-agent2)','Vizoure Agent (vizoure-agent2)'),'Zabbix Agent 2','Vizoure Agent 2'),'zabbix-agent2','vizoure-agent2'),'Zabbix agent 2','Vizoure agent 2'),'Zabbix agent','Vizoure agent'),'Zabbix HTTP agent','Vizoure HTTP agent'),'Zabbix SNMP agent','Vizoure SNMP agent') WHERE (description LIKE '%Zabbix%' OR description LIKE '%zabbix%') AND status=3;
UPDATE vizoure.hosts SET description = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(description,'Zabbix SNMP Agent','Vizoure SNMP Agent'),'Zabbix Java Gateway','Vizoure Java Gateway'),'Zabbix Java gateway','Vizoure Java gateway'),'Zabbix Helm Chart','Vizoure Helm Chart'),'Zabbix Helm chart','Vizoure Helm chart'),'Zabbix IAM policy','Vizoure IAM policy'),'Zabbix 7.4 ','Vizoure 7.4 ') WHERE description LIKE '%Zabbix%' AND status=3;
UPDATE vizoure.hosts SET description = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(description,'Zabbix 7.4.','Vizoure 7.4.'),'Zabbix 7.4,','Vizoure 7.4,'),'Zabbix 7.4+','Vizoure 7.4+'),'Zabbix Documentation','Vizoure Documentation'),'Zabbix Event Priority','Vizoure Event Priority'),'Zabbix Event Source','Vizoure Event Source'),'Zabbix Event Status','Vizoure Event Status') WHERE description LIKE '%Zabbix%' AND status=3;
UPDATE vizoure.hosts SET description = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(description,'Zabbix GitHub Webhook','Vizoure GitHub Webhook'),'Zabbix/7.4','Vizoure/7.4'),'the local Zabbix server','the local Vizoure server'),'the local Zabbix proxy','the local Vizoure proxy'),'the remote Zabbix server','the remote Vizoure server'),'the remote Zabbix proxy','the remote Vizoure proxy'),'Zabbix bulk data collection','Vizoure bulk data collection') WHERE description LIKE '%Zabbix%' AND status=3;
UPDATE vizoure.hosts SET description = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(description,'New Zabbix Agent','New Vizoure Agent'),'Zabbix server or Zabbix proxy','Vizoure server or Vizoure proxy'),'the Zabbix server or the Zabbix proxy','the Vizoure server or the Vizoure proxy'),'from Zabbix proxy or Zabbix server','from Vizoure proxy or Vizoure server'),'monitor Zabbix server metrics','monitor Vizoure server metrics'),'our Zabbix server/proxy','our Vizoure server/proxy'),'from Zabbix server/proxy','from Vizoure server/proxy') WHERE description LIKE '%Zabbix%' AND status=3;
UPDATE vizoure.hosts SET description = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(description,'Zabbix server uses','Vizoure server uses'),'only Zabbix server can reach','only Vizoure server can reach'),'that only Zabbix server','that only Vizoure server'),'internal Zabbix metrics','internal Vizoure metrics'),'by Zabbix that work without','by Vizoure that work without'),'by Zabbix that works without','by Vizoure that works without'),'by Zabbix via HTTP','by Vizoure via HTTP') WHERE description LIKE '%Zabbix%' AND status=3;
UPDATE vizoure.hosts SET description = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(description,'by Zabbix via ODBC','by Vizoure via ODBC'),'by Zabbix via','by Vizoure via'),'by Zabbix,','by Vizoure,'),'by Zabbix.','by Vizoure.'),'via Zabbix,','via Vizoure,'),'via Zabbix.','via Vizoure.'),'into Zabbix.','into Vizoure.') WHERE description LIKE '%Zabbix%' AND status=3;
UPDATE vizoure.hosts SET description = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(description,'in Zabbix.','in Vizoure.'),'for Zabbix.','for Vizoure.'),'on Zabbix.','on Vizoure.'),'Zabbix currently supports','Vizoure currently supports'),'both Zabbix and the MSSQL','both Vizoure and the MSSQL'),'the Zabbix official repository','the Vizoure official repository'),'from Zabbix version 5.0','from Vizoure version 5.0') WHERE description LIKE '%Zabbix%' AND status=3;
UPDATE vizoure.hosts SET description = REPLACE(REPLACE(REPLACE(REPLACE(description,'with Zabbix versions','with Vizoure versions'),'the Zabbix side.','the Vizoure side.'),'[Zabbix template operation]','[Vizoure template operation]'),'see the Zabbix server log','see the Vizoure server log') WHERE description LIKE '%Zabbix%' AND status=3;
UPDATE vizoure.hosts SET description = REGEXP_REPLACE(description,'You can discuss this template or leave feedback on our forum[^\n]*\n?','') WHERE description LIKE '%forum%' AND status=3;
UPDATE vizoure.hosts SET description = REGEXP_REPLACE(description,'https://www[.]zabbix[.]com/documentation[^\n]*\n?','') WHERE description LIKE '%zabbix.com/documentation%' AND status=3;
UPDATE vizoure.hosts SET description = REGEXP_REPLACE(description,'https://www[.]zabbix[.]com/forum[^\n]*\n?','') WHERE description LIKE '%zabbix.com/forum%' AND status=3;
UPDATE vizoure.hosts SET description = REGEXP_REPLACE(description,'Generated by official (Vizoure|Zabbix) template tool[^\n]*\n?','') WHERE description LIKE '%Generated by%' AND status=3;
SQLEOF
...
mysql -uroot vizoure < /tmp/vizoure_desc_fix.sql
